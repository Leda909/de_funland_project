...
# Run tests
unit-test:
	$(call execute_in_env, PYTHONPATH=$(PYTHONPATH) pytest test --testdox -vvrP)
...
# separatly run coverage check and report in html format
create-html-coverage-report:
	rm -rf htmlcov
	$(call execute_in_env, coverage html)
